...
const MirandaCard: React.FC = () => {
  ...
  return (
    <div
      className={`flex flex-col h-full bg-card rounded-lg shadow-lg overflow-hidden transition-all duration-300 ease-in-out ${sidebarOpen ? 'w-full' : 'w-16'}`}
            ...
            <div>
              ...
              {language === 'other' && (
                <input
                  ...
                  className="w-full px-4 py-2 mt-2 bg-background border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-ring"
                />
              )}
            </div>
            <div>
              <label htmlFor="miranda-suspect" className="block text-sm font-medium">Suspect Name</label>
              <input
                id="miranda-suspect"
                value={suspectName}
